...
// https://github.com/navikt/isdialogmelding/blob/master/src/main/kotlin/no/nav/syfo/dialogmelding/bestilling/kafka/DialogmeldingToBehandlerBestillingDTO.kt
class DialogmeldingTilBehandlerKafkaDto(
...
data class DialogmeldingFraBehandlerKafkaDto(
    val msgId: String,
    val msgType: String,
    val navLogId: String,
